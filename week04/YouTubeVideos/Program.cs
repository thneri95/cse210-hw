...
class Program
{
    static void Main(string[] args)
    {
        ...
        Video video1 = new Video("The Restoration of the Gospel", "The Church of Jesus Christ", 420);
        ...
        Video video2 = new Video("Jesus Christ: Our Savior", "ComeUntoChrist.org", 360);
        ...
        Video video3 = new Video("Temples: Houses of the Lord", "Latter-day Saints Channel", 510);
